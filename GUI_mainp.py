...
#
label_l1 = tk.Label(root, text="Electricity Theft Detection ",font=("Times New Roman", 30, 'bold'),
                    background="#800080", fg="white", width=67, height=2)
...
img3=ImageTk.PhotoImage(Image.open("bg6.jpg"))
...
frame_alpr = tk.LabelFrame(root, text=" --Login & Register-- ", width=600, height=100, bd=5, font=('times', 14, ' bold '),bg="#808080")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=550, y=450)
...
button4 = tk.Button(frame_alpr, text="Login", command=log, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="#b30000", fg="white")
button4.place(x=80, y=15)

button4 = tk.Button(frame_alpr, text="Registration", command=reg, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="#b30000", fg="white")
...
label_l1 = tk.Label(root, text="** Electricity Theft Detection  @ 2021 by Bitmap Technology **",font=("Times New Roman", 10, 'bold'),
